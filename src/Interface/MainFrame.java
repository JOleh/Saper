...
/**
 * Головний клас-фрейм.
 * Наслідує JFrame і імплементує ActionListener, MouseListener для обробки подій
 * і Restart для рестарту гри.
 */
public class MainFrame extends JFrame implements ActionListener, MouseListener, Restart{
    ...
    /** Конструктор класу.
     * Викликає метод ініціалізації.
     */
    public MainFrame() {
        init();
    }

    /** Метод ініціалізіції вікна і присутніх обєктів*/
    private void init(){
        /* Встановлення заголовку вікна*/
        setTitle("Miner");
        /*Створення іконки для вікна*/
        ImageIcon imageIcon = new ImageIcon(getClass().getResource("/resources/saper.png"));
        /*Встановлення іконки для вікна*/
        setIconImage(imageIcon.getImage());
        /* Встановлення кольору заднього фону*/
        setBackground(Color.GRAY);
        /* Встановлення властивості виходу на кнопку Exit */
        setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
        /* Встановлення вікна видимим*/
        setVisible(true);
        /* Встановлення вікна незмінним в розмірі*/
        setResizable(false);
        /* Встановлення розподіленння компонентів в вікні*/
        setLayout(null);
        /* Встановлення меню в вікно*/
        setJMenuBar(new MenuPanel(this));
        /* Створення обєкут діалогу опцій*/
        optionDialog = new OptionDialog(this);
        /* Створення обєкту діалогу додаткової інформації*/
        infoDialog = new InfoDialog();
        /*Створення обєкту діалогу з привітанням*/
    ...
    private void winWork(){
        ...
        optionsPanel.getStartButton().setIcon(new ImageIcon(getClass().getResource("/resources/smile_win.jpg")));
            ...
            if(e.getButton()==MouseEvent.BUTTON1){
                ...
                if(!temporary.isChecked() && !temporary.isExpected()) {
                    ...
                    if(temporary.isBomb()){
                        ...
                        boardPanel.repaint();
                        /*Зміна іконки на додатковій панелі з кнопкою*/
                        optionsPanel.getStartButton().setIcon(new ImageIcon(getClass().getResource("/resources/smile_lose.jpg")));
                        /*Видалення слухавки для миші для панелі з грою для неспроможності продовжувати гри*/
                        boardPanel.removeMouseListener(this);
                    }
