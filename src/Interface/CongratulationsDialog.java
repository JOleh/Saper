...
class CongratulationsDialog extends JDialog {
    ...
    CongratulationsDialog() {
        ...
        JLabel imageLabel = new JLabel(new ImageIcon(getClass().getResource("/resources/congratulations.png")));
        ...
        JLabel buttonLabel = new JLabel(new ImageIcon(getClass().getResource("/resources/ok.png")));
